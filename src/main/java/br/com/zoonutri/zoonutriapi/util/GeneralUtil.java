package br.com.zoonutri.zoonutriapi.util;
...
public class GeneralUtil {
     ...
     * @return Detalhes do usuário logado.
     */
    public static MyUserDetails getLoggedUser() {
        return getNamesAuthentication();
    }

    /**
     * Obtém os detalhes de autenticação do usuário logado.
     * @return Detalhes do usuário logado.
     * @throws IllegalArgumentException Se não houver autenticação disponível ou ocorrer um erro interno.
     */
    ...
    /**
     * Retorna uma mensagem localizada com base na chave fornecida.
     *
     * @param message Chave da mensagem a ser recuperada.
     * @return A mensagem localizada correspondente à chave.
     * @throws MissingResourceException Se a chave não puder ser encontrada no ResourceBundle.
     */
    ...
    /**
     * Retorna o valor de hash MD5 de uma string.
     *
     * @param input A string para a qual o valor hash MD5 será calculado.
     * @return O valor hash MD5 como uma representação hexadecimal.
    ...
    /**
     * Gera e retorna uma palavra aleatória de 10 caracteres composta por letras minúsculas.
     * @return Uma string contendo uma palavra aleatória.
     */
